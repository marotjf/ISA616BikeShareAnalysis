...
*	**weather:** 
    ...
    + 4 = winter. Light Snow, Light Rain + Thunderstorm + Scattered clouds, Light Rain + Scattered clouds
...
*	**count:** number of total rentals (Note that casual+registered=count, so you shouldn’t use casual and registered to predict count. I have included the breakdown in case you wish to predict casual and registered with separate models.)
